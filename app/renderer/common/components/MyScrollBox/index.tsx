...
function MyScrollBox({ children, maxHeight = 200, style = {}, innerStyle = {}, onScrollTop }: IProps) {
  ...
  return (
    <div className={less['scroll-box-outer']} style={_style} onScroll={onScroll}>
      <div className={less['scroll-box-hidden']} style={{ maxHeight: `${maxHeight}px` }}>
        <div className={less['scroll-box-inter']} style={innerStyle}>
          {children}
        </div>
      </div>
    </div>
