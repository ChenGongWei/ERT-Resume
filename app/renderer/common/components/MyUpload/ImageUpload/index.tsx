 ...
 */
 ...
 const ImageUpload: React.FC<IProps> = ({
   ...
   return (
     <div className={style['my_input_image_upload_wrapper']} onClick={onAfterClick}>
       {!preventInputManager && (
         <div className={style['my_input_image_upload_input']}>
           <Upload {...otherProps} onAfterClick={() => {}} style={{ width: '112px', height: '152px' }} />
         </div>
       )}
       <div className={style['my_input_image_upload_box']}>
         <img src={icon} className={style['my_input_image_upload__icon']} />
         <p>{text}</p>
       </div>
     </div>
   );
